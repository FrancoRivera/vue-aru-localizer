...
var Localizer = function () {
  function Localizer() {
    ...
    if (localStorage.getItem('aru-language') !== null && localStorage.getItem('aru-language') !== undefined ) data.lang = localStorage.getItem('aru-language');
    window.localStorage.setItem('aru-language',data.lang);
